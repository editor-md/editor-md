    ...
    var factory = function (exports) {
        ...
        exports.fn.optionsDialog = function() {
            ...
            var dialogContent = [
                ...
                "<select id=\"edit-toolbar-area-keymapmodes-select\"style=\"width:200px;margin:3px 0 0 0;\"></select><br/>",
                ...
                dialog = this.createDialog({
                    ...
                    buttons    : {
                        enter : [lang.buttons.enter, function() {
                            ...
                            _this.setKeymapMode(optionsValue["KeymapMode"]);
            ...
            themeSelect("#edit-toolbar-area-keymapmodes-select", editormd.keymapModes, settings.KeymapMode);
        };
